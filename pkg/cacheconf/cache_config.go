...
// setField - Try to sets the value passed to an CacheConfigInterface, 
...
// LoadEnvConfig - Try to init the CacheConfigInterface using DefaultCacheConfig 
// for default config fields and the custom CacheConfig passed as CacheConfigInterface, 
// requires that "c" is a pointer to your custom CacheConfig
